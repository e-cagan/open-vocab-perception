...
import pytest
from ovp.core.types import Detection, BoundingBox, Track
...
class TestSingleObjectTracking:
    def test_single_object_consistent_id(self):
        ...
        assert len(set(track_ids_seen)) == 1, \
            f"Track ID changed mid-sequence: {track_ids_seen}"
    ...
    def test_two_objects_consistent_ids_over_time(self):
        ...
        for frame_idx in range(3):
            ...
            if first_frame_ids is None:
                ...
                assert current_ids == first_frame_ids, \
                    f"Frame {frame_idx}: track IDs changed"
